...
import structlog
# TODO(DEADCODE): plan_concept import — interactive concept planning only. See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
# from feynman_teaching_kernel import plan_concept
from livekit.agents import Agent, AgentServer, AgentSession, JobContext, cli
from livekit.rtc import DataPacket

# TODO(DEADCODE): Group-2 imports: action_tag_parser / board_verifier / curriculum_loader (interactive only). See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): Group-2 imports: drift_state / lesson_plan / prompts / action_tag_dispatch (interactive only). See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): Group-2 imports: scene_graph / state_machine / states / teaching_context / tools (interactive only). See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): drift-check constants — interactive only. See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): ALL_TOOLS — interactive agent toolset. See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): strip_action_tags — interactive tts_node only. See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): drain_perception_feedback — interactive only. See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): periodic drift-check helpers — interactive only. See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): FeynmanAgent — interactive live-teaching agent (parked). See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
...
# TODO(DEADCODE): interactive teaching entrypoint — parked; active product uses lecture mode only. See docs/engineering/13-redundant-code-audit.md Group 2. Safe to delete.
