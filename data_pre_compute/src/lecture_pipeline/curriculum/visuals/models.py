"""DiagramSpec Pydantic models for visual pre-generation.

Copied from design_agent/backend/schema.py to keep the pipeline package
self-contained. The canonical source lives in design_agent; Phase 13 cleanup
can deduplicate into a shared package.
"""
